...
public class ConfigurationMessages {
    ...
    public void getConfig() {
        this.config = new ConfigAPI(this.freeframe.getDataFolder().getPath(), "config.yml", this.freeframe);
        this.config.getConfig().addDefault("freeframe.prefix", (Object)"&eFreeFrame &8\u00bb");
        this.config.getConfig().addDefault("freeframe.reload.permission", (Object)"freeframe.reload");
        ...
        this.config.getConfig().addDefault("freeframe.destroy.permission", (Object)"freeframe.destroy");
    ...
    public void reloadPermissionNodes() {
        Var.PERMISSION_FREEFRAME_RELOAD = this.config.getConfig().getString("freeframe.reload.permission", "freeframe.reload");
        Var.PERMISSION_FREEFRAME_DESTROY = this.config.getConfig().getString("freeframe.destroy.permission", "freeframe.destroy");
    }
}
